...
namespace MenuConfig
{
	...
	struct {
		...
		ImColor BorderColor_Yellow	= ImColor(160, 0, 255, 255);
		ImColor BorderColor_Purple	= ImColor(160, 0, 255, 255);
	...
	// Theme Configs
	inline ImColor ButtonBorderColor = ImColor(160, 0, 255, 255);
}
...
namespace ESPConfig
{
	...
	inline ImColor BoxColor = ImColor(160, 0, 255, 255);
...
namespace MiscCFG
{
	...
	inline ImColor BombTimerCol = ImColor(160, 0, 255, 255);
