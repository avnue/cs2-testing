...
ID3D11ShaderResourceView* LUL_Logo = NULL;
...
namespace GUI
{
	...
	{
		LoadImages();
		ImVec2 LogoPos = MenuConfig::WCS.LogoPos;
		ImColor BorderColor = MenuConfig::WCS.BorderColor_Purple;
		...
		ImGui::Begin("LevelUpLabs", nullptr, Flags);
		{
			ImGui::SetCursorPos(LogoPos);
			ImGui::PushFont(ImGui::GetIO().Fonts->Fonts[0]);
			ImGui::TextColored(ImVec4(0.63f, 0.0f, 1.0f, 1.0f), "LevelUp");
			ImGui::SameLine(0, 2);
			ImGui::TextColored(ImVec4(1.0f, 1.0f, 1.0f, 1.0f), "Labs.xyz");
			ImGui::PopFont();
			...
			ImGui::BeginChild("Page", MenuConfig::WCS.ChildSize);
			{
				...
				if (MenuConfig::WCS.MenuPage == 2)
				{
					...
					ImGui::SameLine();
					if (ImGui::Combo("###Theme", &MenuConfig::Theme, "LevelUpLabs\0"))
